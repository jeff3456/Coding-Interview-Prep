 ...
 * Problem Statement
 ...
 we sometimes use the initial letters of words to form its acronym. 
 For example, we use "JFK" instead of "John Fitzgerald Kennedy", 
 "lgtm" instead of "looks good to me", and so on. 
 ...
 * 
 */
import interviewprep.FastReader;

public class CreateAcronym {
  public static void main(String[] args){
    FastReader reader = new FastReader();
    String acro = "";
    while(reader.st == null || reader.st.hasMoreTokens()){
